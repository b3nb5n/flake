    ...
    in with config.theme.color // usrLib.color; {
      ...
      "workbench.colorCustomizations" = {
        ...
        "selection.background" =
          hex (if isDarkTheme then accent.dark else accent.light);
        ...
        "scrollbarSlider.background" =
          hexA (builtins.elemAt bg 3) highlightAlpha;
        ...
        "activityBar.background" =
          hex (builtins.elemAt bg 0); # Activity Bar background color.
        "activityBar.dropBorder" = hex (builtins.elemAt fg
          0); # Drag and drop feedback color for the activity bar items. The activity bar is showing on the far left or right and allows to switch between views of the side bar.
        "activityBar.foreground" = hex
          accent.default; # Activity Bar foreground color (for example used for the icons).
        "activityBar.inactiveForeground" = hex (builtins.elemAt fg
          2); # Activity Bar item foreground color when it is inactive.
        "activityBar.border" = hex
          (builtins.elemAt bg 1); # Activity Bar border color with the Side Bar.
        "activityBarBadge.background" =
          hex accent.default; # Activity notification badge background color.
        "activityBarBadge.foreground" = hex (builtins.elemAt bg
          0); # Activity notification badge foreground color.
        "activityBar.activeBorder" = hex
          (builtins.elemAt bg 0); # Activity Bar active indicator border color.
        "activityBar.activeBackground" = hex (builtins.elemAt bg
          0); # Activity Bar optional background color for the active element.
        "activityBar.activeFocusBorder" = hex (builtins.elemAt bg
          0); # Activity bar focus border color for the active item.
        ...
        "editorGroupHeader.border" = hex (builtins.elemAt bg
          0); # Border color between editor group header and editor (below breadcrumbs if enabled).
        "editorGroup.emptyBackground" = hex
          (builtins.elemAt bg 0); # Background color of an empty editor group.
        "editorGroup.focusedEmptyBorder" = hex (builtins.elemAt bg
          1); # Border color of an empty editor group that is focused.
        "editorGroup.dropIntoPromptForeground" = hex (builtins.elemAt fg
          1); # Foreground color of text shown over editors when dragging files. This text informs the user that they can hold shift to drop into the editor.
        "editorGroup.dropIntoPromptBackground" = hex (builtins.elemAt bg
          1); # Background color of text shown over editors when dragging files. This text informs the user that they can hold shift to drop into the editor.
        "editorGroup.dropIntoPromptBorder" = hex (builtins.elemAt bg
          1); # Border color of text shown over editors when dragging files. This text informs the user that they can hold shift to drop into the editor.
        "tab.activeBackground" = hex (builtins.elemAt bg
          0); # Active Tab background color in an active group.
        "tab.unfocusedActiveBackground" = hex (builtins.elemAt bg
          1); # Active Tab background color in an inactive editor group.
        "tab.activeForeground" = hex (builtins.elemAt fg
          0); # Active Tab foreground color in an active group.
        "tab.border" =
          hex (builtins.elemAt bg 1); # Border to separate Tabs from each other.
        "tab.activeBorder" =
          hex accent.default; # Bottom border for the active tab.
        "tab.unfocusedActiveBorder" = hex
          accent.default; # Bottom border for the active tab in an inactive editor group.
        "tab.activeBorderTop" = "#00000000"; # Top border for the active tab.
        "tab.unfocusedActiveBorderTop" =
          "#00000000"; # Top border for the active tab in an inactive editor group
        "tab.lastPinnedBorder" = hex (builtins.elemAt bg
          1); # Border on the right of the last pinned editor to separate from unpinned editors.
        "tab.inactiveBackground" =
          hex (builtins.elemAt bg 0); # Inactive Tab background color.
        "tab.unfocusedInactiveBackground" = hex (builtins.elemAt bg
          0); # Inactive Tab background color in an unfocused group
        "tab.inactiveForeground" = hex (builtins.elemAt fg
          1); # Inactive Tab foreground color in an active group.
        "tab.unfocusedActiveForeground" = hex (builtins.elemAt fg
          1); # Active tab foreground color in an inactive editor group.
        "tab.unfocusedInactiveForeground" = hex (builtins.elemAt fg
          2); # Inactive tab foreground color in an inactive editor group.
        "tab.hoverBackground" =
          hex (builtins.elemAt bg 0); # Tab background color when hovering
        "tab.unfocusedHoverBackground" = hex (builtins.elemAt bg
          1); # Tab background color in an unfocused group when hovering
        "tab.hoverForeground" =
          hex (builtins.elemAt fg 0); # Tab foreground color when hovering
        "tab.unfocusedHoverForeground" = hex (builtins.elemAt fg
          0); # Tab foreground color in an unfocused group when hovering
        "tab.hoverBorder" =
          hex accent.default; # Border to highlight tabs when hovering
        "tab.unfocusedHoverBorder" = hex (builtins.elemAt bg
          0); # Border to highlight tabs in an unfocused group when hovering
        "tab.activeModifiedBorder" = hex (builtins.elemAt bg
          0); # Border on the top of modified (dirty) active tabs in an active group.
        "tab.inactiveModifiedBorder" = hex (builtins.elemAt bg
          0); # Border on the top of modified (dirty) inactive tabs in an active group.
        "tab.unfocusedActiveModifiedBorder" = hex (builtins.elemAt bg
          0); # Border on the top of modified (dirty) active tabs in an unfocused group.
        "tab.unfocusedInactiveModifiedBorder" = hex (builtins.elemAt bg
          0); # Border on the top of modified (dirty) inactive tabs in an unfocused group.
        "editorPane.background" = hex (builtins.elemAt bg
          0); # Background color of the editor pane visible on the left and right side of the centered editor layout.
        "sideBySideEditor.horizontalBorder" = hex (builtins.elemAt bg
          0); # Color to separate two editors from each other when shown side by side in an editor group from top to bottom.
        "sideBySideEditor.verticalBorder" = hex (builtins.elemAt bg
          0); # Color to separate two editors from each other when shown side by side in an editor group from left to right.

        "editor.background" =
          hex (builtins.elemAt bg 1); # Editor background color.
        "editor.foreground" =
          hex (builtins.elemAt fg 0); # Editor default foreground color.
        "editorLineNumber.foreground" =
          hex (builtins.elemAt bg 3); # Color of editor line numbers.
        "editorLineNumber.activeForeground" =
          hex (builtins.elemAt fg 3); # Color of the active editor line number.
        "editorCursor.background" = hex (builtins.elemAt fg
          0); # The background color of the editor cursor. Allows customizing the color of a character overlapped by a block cursor.
        "editorCursor.foreground" =
          hex (builtins.elemAt fg 0); # Color of the editor cursor.
        "editor.selectionBackground" =
          hexA accent.default highlightAlpha; # Color of the editor selection.
        "editor.inactiveSelectionBackground" = hexA gray.default
          highlightAlpha; # Color of the selection in an inactive editor. The color must not be opaque so as not to hide underlying decorations.
        "editor.selectionForeground" = hex (builtins.elemAt bg
          0); # Color of the selected text for high contrast.
        ...
        "editor.findMatchBackground" = hexA accent.default
          highlightAlpha; # Color of the current search match.
        "editor.findMatchHighlightBackground" = hexA gray.default
          highlightAlpha; # Color of the other search matches. The color must not be opaque so as not to hide underlying decorations.
        "editor.findRangeHighlightBackground" = hex (builtins.elemAt bg
          3); # Color the range limiting the search (Enable 'Find in Selection' in the find widget). The color must not be opaque so as not to hide underlying decorations.
        ...
        "search.resultsInfoForeground" = hex (builtins.elemAt fg
          1); # Color of the text in the search viewlet's completion message. For example, this color is used in the text that says "{x} results in {y} files".
        "searchEditor.findMatchBackground" =
          hexA accent.default highlightAlpha; # Color of the editor's results.
        ...
        "editor.hoverHighlightBackground" = hexA (builtins.elemAt bg 3)
          highlightAlpha; # Highlight below the word for which a hover is shown. The color must not be opaque so as not to hide underlying decorations.
        "editor.lineHighlightBackground" =
          "#00000000"; # Background color for the highlight of line at the cursor position.
        "editor.lineHighlightBorder" =
          "#00000000"; # Background color for the border around the line at the cursor position.
        ...
        "editorLink.activeForeground" =
          hex accent.default; # Color of active links.
        ...
        "editorIndentGuide.background1" =
          hex gray.default; # Color of the editor indentation guides.
        ...
        "editorIndentGuide.activeBackground1" = hex (builtins.elemAt fg
          1); # Color of the active editor indentation guide.
        ...
        "editorInlayHint.background" =
          "#00000000"; # Background color of inline hints.
        "editorInlayHint.foreground" =
          hex (builtins.elemAt bg 3); # Foreground color of inline hints.
        ...
        "editorLightBulb.foreground" =
          hex yellow.default; # The color used for the lightbulb actions icon.
        "editorLightBulbAutoFix.foreground" = hex
          yellow.default; # The color used for the lightbulb auto fix actions icon.
        "editorBracketMatch.background" =
          "#00000000"; # Background color behind matching brackets.
        "editorBracketMatch.border" =
          "#00000000"; # Color for matching brackets boxes.
        "editorBracketHighlight.foreground1" = hex
          yellow.light; # Foreground color of brackets (1). Requires enabling bracket pair colorization.
        "editorBracketHighlight.foreground2" = hex
          pink.light; # Foreground color of brackets (2). Requires enabling bracket pair colorization.
        "editorBracketHighlight.foreground3" = hex
          cyan.light; # Foreground color of brackets (3). Requires enabling bracket pair colorization.
        "editorBracketHighlight.foreground4" = hex
          orange.light; # Foreground color of brackets (4). Requires enabling bracket pair colorization.
        "editorBracketHighlight.foreground5" = hex
          green.light; # Foreground color of brackets (5). Requires enabling bracket pair colorization.
        "editorBracketHighlight.foreground6" = hex
          purple.light; # Foreground color of brackets (6). Requires enabling bracket pair colorization.
        "editorBracketHighlight.unexpectedBracket" = hex
          red.default; # foreground: Foreground color of unexpected brackets.
        ...
        "editorOverviewRuler.findMatchForeground" = hex
          accent.light; # Overview ruler marker color for find matches. The color must not be opaque so as not to hide underlying decorations.
        ...
        "editorOverviewRuler.selectionHighlightForeground" = hex
          gray.default; # Overview ruler marker color for selection highlights. The color must not be opaque so as not to hide underlying decorations.
        "editorOverviewRuler.wordHighlightForeground" = hex
          gray.light; # Overview ruler marker color for symbol highlights. The color must not be opaque so as not to hide underlying decorations.
        ...
        "editorOverviewRuler.modifiedForeground" =
          hex blue.light; # Overview ruler marker color for modified content.
        "editorOverviewRuler.addedForeground" =
          hex green.light; # Overview ruler marker color for added content.
        "editorOverviewRuler.deletedForeground" =
          hex red.light; # Overview ruler marker color for deleted content.
        "editorOverviewRuler.errorForeground" =
          hex red.default; # Overview ruler marker color for errors.
        "editorOverviewRuler.warningForeground" =
          hex yellow.default; # Overview ruler marker color for warnings.
        "editorOverviewRuler.infoForeground" =
          hex blue.default; # Overview ruler marker color for infos.
        "editorOverviewRuler.bracketMatchForeground" =
          hex gray.light; # Overview ruler marker color for matching brackets.
        "editorError.foreground" =
          hex red.default; # Foreground color of error squiggles in the editor.
        ...
        "editorWarning.foreground" = hex
          yellow.default; # Foreground color of warning squiggles in the editor.
        ...
        "editorInfo.foreground" =
          hex blue.default; # Foreground color of info squiggles in the editor.
        ...
        "editorHint.foreground" =
          hex green.default; # Foreground color of hints in the editor.
        # "editorHint.border" = ; # Border color of hint boxes in the editor.
        "problemsErrorIcon.foreground" =
          hex red.default; # The color used for the problems error icon.
        "problemsWarningIcon.foreground" =
          hex yellow.default; # The color used for the problems warning icon.
        "problemsInfoIcon.foreground" =
          hex blue.default; # The color used for the problems info icon.
        ...
        "editorGutter.modifiedBackground" = hex
          blue.default; # Editor gutter background color for lines that are modified.
        "editorGutter.addedBackground" = hex
          green.default; # Editor gutter background color for lines that are added.
        "editorGutter.deletedBackground" = hex
          red.default; # Editor gutter background color for lines that are deleted.
        ...
        "diffEditor.insertedTextBackground" = hexA green.light
          highlightAlpha; # Background color for text that got inserted. The color must not be opaque so as not to hide underlying decorations.
        # "diffEditor.insertedTextBorder" = ; # Outline color for the text that got inserted.
        "diffEditor.removedTextBackground" = hexA red.light
          highlightAlpha; # Background color for text that got removed. The color must not be opaque so as not to hide underlying decorations.
        # "diffEditor.removedTextBorder" = ; # Outline color for text that got removed.
        "diffEditor.border" = hex
          (builtins.elemAt bg 0); # Border color between the two text editors.
        "diffEditor.diagonalFill" = hex (builtins.elemAt bg
          0); # Color of the diff editor's diagonal fill. The diagonal fill is used in side-by-side diff views.
        "diffEditor.insertedLineBackground" = hexA green.light
          highlightAlpha; # Background color for lines that got inserted. The color must not be opaque so as not to hide underlying decorations.
        "diffEditor.removedLineBackground" = hexA red.light
          highlightAlpha; # Background color for lines that got removed. The color must not be opaque so as not to hide underlying decorations.
        "diffEditorGutter.insertedLineBackground" = hex
          green.default; # Background color for the margin where lines got inserted.
        "diffEditorGutter.removedLineBackground" = hex
          red.default; # Background color for the margin where lines got removed.
        ...
        "editorWidget.foreground" = hex (builtins.elemAt fg
          0); # Foreground color of editor widgets, such as find/replace.
        "editorWidget.background" = hex (builtins.elemAt bg
          0); # Background color of editor widgets, such as Find/Replace.
        "editorWidget.border" =
          "#00000000"; # Border color of the editor widget unless the widget does not contain a border or defines its own border color.
        "editorWidget.resizeBorder" = hex (builtins.elemAt bg
          2); # Border color of the resize bar of editor widgets. The color is only used if the widget chooses to have a resize border and if the color is not overridden by a widget.
        "editorSuggestWidget.background" = hex
          (builtins.elemAt bg 0); # Background color of the suggestion widget.
        "editorSuggestWidget.border" =
          "#00000000"; # Border color of the suggestion widget.
        "editorSuggestWidget.foreground" = hex
          (builtins.elemAt fg 0); # Foreground color of the suggestion widget.
        "editorSuggestWidget.focusHighlightForeground" = hex (builtins.elemAt fg
          0); # Color of the match highlights in the suggest widget when an item is focused.
        "editorSuggestWidget.highlightForeground" = hex (builtins.elemAt fg
          1); # Color of the match highlights in the suggestion widget.
        "editorSuggestWidget.selectedBackground" = hex
          accent.default; # Background color of the selected entry in the suggestion widget.
        "editorSuggestWidget.selectedForeground" = hex (builtins.elemAt fg
          0); # Foreground color of the selected entry in the suggest widget.
        "editorSuggestWidget.selectedIconForeground" = hex (builtins.elemAt bg
          0); # Icon foreground color of the selected entry in the suggest widget.
        ...
        "panel.background" =
          hex (builtins.elemAt bg 0); # Panel background color.
        "panel.border" = hex (builtins.elemAt bg
          2); # Panel border color to separate the panel from the editor.
        "panel.dropBorder" = hex (builtins.elemAt fg
          1); # Drag and drop feedback color for the panel titles. Panels are shown below the editor area and contain views like output and integrated terminal.
        "panelTitle.activeBorder" =
          hex accent.default; # Border color for the active panel title.
        "panelTitle.activeForeground" =
          hex (builtins.elemAt fg 0); # Title color for the active panel.
        "panelTitle.inactiveForeground" =
          hex (builtins.elemAt fg 1); # Title color for the inactive panel.
        "panelInput.border" = hex
          (builtins.elemAt bg 1); # Input box border for inputs in the panel.
        "panelSection.border" = hex (builtins.elemAt bg
          1); # Panel section border color used when multiple views are stacked horizontally in the panel. Panels are shown below the editor area and contain views like output and integrated terminal.
        "panelSection.dropBackground" = hex (builtins.elemAt bg
          1); # Drag and drop feedback color for the panel sections. The color should have transparency so that the panel sections can still shine through. Panels are shown below the editor area and contain views like output and integrated terminal.
        "panelSectionHeader.background" = hex (builtins.elemAt bg
          0); # Panel section header background color. Panels are shown below the editor area and contain views like output and integrated terminal.
        "panelSectionHeader.foreground" = hex (builtins.elemAt fg
          0); # Panel section header foreground color. Panels are shown below the editor area and contain views like output and integrated terminal.
        "panelSectionHeader.border" = hex (builtins.elemAt bg
          1); # Panel section header border color used when multiple views are stacked vertically in the panel. Panels are shown below the editor area and contain views like output and integrated terminal.

        "statusBar.background" =
          hex (builtins.elemAt bg 0); # Standard Status Bar background color.
        "statusBar.foreground" =
          hex (builtins.elemAt fg 0); # Status Bar foreground color.
        "statusBar.border" =
          "#00000000"; # Status Bar border color separating the Status Bar and editor.
        "statusBar.debuggingBackground" = hex
          pink.default; # Status Bar background color when a program is being debugged.
        "statusBar.debuggingForeground" = hex (builtins.elemAt bg
          0); # Status Bar foreground color when a program is being debugged.
        "statusBar.debuggingBorder" =
          "#00000000"; # Status Bar border color separating the Status Bar and editor when a program is being debugged.
        "statusBar.noFolderForeground" = hex (builtins.elemAt fg
          0); # Status Bar foreground color when no folder is opened.
        "statusBar.noFolderBackground" = hex (builtins.elemAt bg
          0); # Status Bar background color when no folder is opened.
        "statusBar.noFolderBorder" = hex (builtins.elemAt bg
          1); # Status Bar border color separating the Status Bar and editor when no folder is opened.
        "statusBarItem.activeBackground" = hex (builtins.elemAt bg
          2); # Status Bar item background color when clicking.
        "statusBarItem.hoverForeground" = hex (builtins.elemAt fg
          0); # Status bar item foreground color when hovering. The status bar is shown in the bottom of the window.
        "statusBarItem.hoverBackground" = hex (builtins.elemAt bg
          2); # Status Bar item background color when hovering.
        "statusBarItem.prominentForeground" = hex
          (builtins.elemAt fg 0); # Status Bar prominent items foreground color.
        "statusBarItem.prominentBackground" = hex
          (builtins.elemAt bg 0); # Status Bar prominent items background color.
        "statusBarItem.prominentHoverForeground" = hex (builtins.elemAt fg
          0); # Status bar prominent items foreground color when hovering. Prominent items stand out from other status bar entries to indicate importance. The status bar is shown in the bottom of the window.
        "statusBarItem.prominentHoverBackground" = hex (builtins.elemAt bg
          2); # Status Bar prominent items background color when hovering.
        "statusBarItem.remoteBackground" = hex
          accent.default; # Background color for the remote indicator on the status bar.
        "statusBarItem.remoteForeground" = hex (builtins.elemAt bg
          0); # Foreground color for the remote indicator on the status bar.
        "statusBarItem.remoteHoverBackground" = hex
          accent.light; # Background color for the remote indicator on the status bar when hovering.
        "statusBarItem.remoteHoverForeground" = hex (builtins.elemAt bg
          0); # Foreground color for the remote indicator on the status bar when hovering.
        "statusBarItem.errorBackground" = hex
          red.default; # Status bar error items background color. Error items stand out from other status bar entries to indicate error conditions.
        "statusBarItem.errorForeground" = hex (builtins.elemAt bg
          0); # Status bar error items foreground color. Error items stand out from other status bar entries to indicate error conditions.
        "statusBarItem.errorHoverBackground" = hex
          red.light; # Status bar error items background color when hovering. Error items stand out from other status bar entries to indicate error conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.errorHoverForeground" = hex (builtins.elemAt bg
          0); # Status bar error items foreground color when hovering. Error items stand out from other status bar entries to indicate error conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.warningBackground" = hex
          yellow.default; # Status bar warning items background color. Warning items stand out from other status bar entries to indicate warning conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.warningForeground" = hex (builtins.elemAt bg
          0); # Status bar warning items foreground color. Warning items stand out from other status bar entries to indicate warning conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.warningHoverBackground" = hex
          yellow.light; # Status bar warning items background color when hovering. Warning items stand out from other status bar entries to indicate warning conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.warningHoverForeground" = hex (builtins.elemAt bg
          0); # Status bar warning items foreground color when hovering. Warning items stand out from other status bar entries to indicate warning conditions. The status bar is shown in the bottom of the window.
        "statusBarItem.compactHoverBackground" = hex (builtins.elemAt bg
          2); # Status bar item background color when hovering an item that contains two hovers. The status bar is shown in the bottom of the window.
        "statusBarItem.focusBorder" = hex
          accent.default; # Status bar item border color when focused on keyboard navigation. The status bar is shown in the bottom of the window.
        "statusBar.focusBorder" = hex
          accent.default; # Status bar border color when focused on keyboard navigation. The status bar is shown in the bottom of the window.
        "statusBarItem.offlineBackground" = hex
          gray.default; # Status bar item background color when the workbench is offline.
        "statusBarItem.offlineForeground" = hex (builtins.elemAt fg
          0); # Status bar item foreground color when the workbench is offline.
        "statusBarItem.offlineHoverForeground" = hex (builtins.elemAt fg
          0); # Status bar item foreground hover color when the workbench is offline.
        "statusBarItem.offlineHoverBackground" = hex
          gray.light; # Status bar item background hover color when the workbench is offline.
        ...
        "menu.foreground" =
          hex (builtins.elemAt fg 0); # Foreground color of menu items.
        "menu.background" =
          hex (builtins.elemAt bg 0); # Background color of menu items.
        "menu.selectionForeground" = hex (builtins.elemAt fg
          0); # Foreground color of the selected menu item in menus.
        "menu.selectionBackground" = hex
          accent.default; # Background color of the selected menu item in menus.
        "menu.selectionBorder" =
          "#00000000"; # Border color of the selected menu item in menus.
        "menu.separatorBackground" =
          hex (builtins.elemAt bg 1); # Color of a separator menu item in menus.
        "menu.border" = hex (builtins.elemAt bg 1); # Border color of menus.

        "commandCenter.foreground" =
          hex (builtins.elemAt fg 0); # Foreground color of the Command Center.
        "commandCenter.activeForeground" = hex (builtins.elemAt fg
          0); # Active foreground color of the Command Center.
        "commandCenter.background" =
          hex (builtins.elemAt bg 0); # Background color of the Command Center.
        "commandCenter.activeBackground" =
          hex accent.default; # Active background color of the Command Center.
        "commandCenter.border" =
          hex (builtins.elemAt bg 2); # Border color of the Command Center.
        "commandCenter.inactiveForeground" = hex (builtins.elemAt fg
          1); # Foreground color of the Command Center when the window is inactive.
        "commandCenter.inactiveBorder" = hex (builtins.elemAt bg
          2); # Border color of the Command Center when the window is inactive.
        "commandCenter.activeBorder" = hex
          (builtins.elemAt bg 2); # Active border color of the Command Center.
        "commandCenter.debuggingBackground" = hex (builtins.elemAt bg
          2); # Command Center background color when a program is being debugged

        "notificationCenter.border" =
          hex (builtins.elemAt bg 2); # Notification Center border color.
        "notificationCenterHeader.foreground" = hex
          (builtins.elemAt fg 0); # Notification Center header foreground color.
        "notificationCenterHeader.background" = hex
          (builtins.elemAt bg 0); # Notification Center header background color.
        "notificationToast.border" =
          hex (builtins.elemAt bg 2); # Notification toast border color.
        "notifications.foreground" =
          hex (builtins.elemAt fg 0); # Notification foreground color.
        "notifications.background" =
          hex (builtins.elemAt bg 0); # Notification background color.
        "notifications.border" = hex (builtins.elemAt bg
          2); # Notification border color separating from other notifications in the Notification Center.
        "notificationLink.foreground" =
          hex accent.default; # Notification links foreground color.
        "notificationsErrorIcon.foreground" =
          hex red.default; # The color used for the notification error icon.
        "notificationsWarningIcon.foreground" = hex
          yellow.default; # The color used for the notification warning icon.
        "notificationsInfoIcon.foreground" =
          hex blue.default; # The color used for the notification info icon.

        "terminal.background" = hex (builtins.elemAt bg
          0); # The background of the Integrated Terminal's viewport.
        "terminal.border" = hex (builtins.elemAt bg
          2); # The color of the border that separates split panes within the terminal. This defaults to panel.border.
        "terminal.foreground" = hex (builtins.elemAt fg
          0); # The default foreground color of the Integrated Terminal.
        "terminal.ansiBlack" =
          hex black.default; # 'Black' ANSI color in the terminal.
        "terminal.ansiBlue" =
          hex blue.default; # 'Blue' ANSI color in the terminal.
        "terminal.ansiBrightBlack" =
          hex black.light; # 'BrightBlack' ANSI color in the terminal.
        "terminal.ansiBrightBlue" =
          hex blue.light; # 'BrightBlue' ANSI color in the terminal.
        "terminal.ansiBrightCyan" =
          hex cyan.light; # 'BrightCyan' ANSI color in the terminal.
        "terminal.ansiBrightGreen" =
          hex green.light; # 'BrightGreen' ANSI color in the terminal.
        "terminal.ansiBrightMagenta" =
          hex pink.light; # 'BrightMagenta' ANSI color in the terminal.
        "terminal.ansiBrightRed" =
          hex red.light; # 'BrightRed' ANSI color in the terminal.
        "terminal.ansiBrightWhite" =
          hex white.light; # 'BrightWhite' ANSI color in the terminal.
        "terminal.ansiBrightYellow" =
          hex yellow.light; # 'BrightYellow' ANSI color in the terminal.
        "terminal.ansiCyan" =
          hex cyan.default; # 'Cyan' ANSI color in the terminal.
        "terminal.ansiGreen" =
          hex green.default; # 'Green' ANSI color in the terminal.
        "terminal.ansiMagenta" =
          hex pink.default; # 'Magenta' ANSI color in the terminal.
        "terminal.ansiRed" =
          hex red.default; # 'Red' ANSI color in the terminal.
        "terminal.ansiWhite" =
          hex white.default; # 'White' ANSI color in the terminal.
        "terminal.ansiYellow" =
          hex yellow.default; # 'Yellow' ANSI color in the terminal.
        "terminal.selectionBackground" =
          hex accent.default; # The selection background color of the terminal.
        ...
        "terminal.inactiveSelectionBackground" = hexA (builtins.elemAt bg 2)
          highlightAlpha; # The selection background color of the terminal when it does not have focus.
        "terminal.findMatchBackground" = hexA accent.default
          highlightAlpha; # Color of the current search match in the terminal. The color must not be opaque so as not to hide underlying terminal content.
        "terminal.findMatchBorder" =
          "#00000000"; # Border color of the current search match in the terminal.
        "terminal.findMatchHighlightBackground" = hexA (builtins.elemAt bg 2)
          highlightAlpha; # Color of the other search matches in the terminal. The color must not be opaque so as not to hide underlying terminal content.
        "terminal.findMatchHighlightBorder" =
          "#00000000"; # Border color of the other search matches in the terminal.
        "terminal.hoverHighlightBackground" = hexA (builtins.elemAt bg 2)
          highlightAlpha; # Color of the highlight when hovering a link in the terminal.
        ...
        "terminalCursor.foreground" = hex
          (builtins.elemAt fg 0); # The foreground color of the terminal cursor.
        ...
        "terminal.tab.activeBorder" = hex
          accent.default; # Border on the side of the terminal tab in the panel. This defaults to tab.activeBorder.
        "terminalCommandDecoration.defaultBackground" = hex
          gray.default; # The default terminal command decoration background color.
        "terminalCommandDecoration.successBackground" = hex
          green.default; # The terminal command decoration background color for successful commands.
        "terminalCommandDecoration.errorBackground" = hex
          red.default; # The terminal command decoration background color for error commands.
        ...
        "gitDecoration.addedResourceForeground" = hex
          green.light; # Color for added Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.modifiedResourceForeground" = hex
          blue.default; # Color for modified Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.deletedResourceForeground" = hex
          red.default; # Color for deleted Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.renamedResourceForeground" = hex
          cyan.default; # Color for renamed or copied Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.stageModifiedResourceForeground" = hex
          blue.light; # Color for staged modifications git decorations. Used for file labels and the SCM viewlet.
        "gitDecoration.stageDeletedResourceForeground" = hex
          red.light; # Color for staged deletions git decorations. Used for file labels and the SCM viewlet.
        "gitDecoration.untrackedResourceForeground" = hex
          green.default; # Color for untracked Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.ignoredResourceForeground" = hex
          gray.default; # Color for ignored Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.conflictingResourceForeground" = hex
          red.default; # Color for conflicting Git resources. Used for file labels and the SCM viewlet.
        "gitDecoration.submoduleResourceForeground" =
          hex (builtins.elemAt fg 0); # Color for submodule resources
        ...
        "breadcrumb.foreground" =
          hex (builtins.elemAt fg 1); # Color of breadcrumb items.
        "breadcrumb.background" =
          hex (builtins.elemAt bg 0); # Background color of breadcrumb items.
        "breadcrumb.focusForeground" =
          hex (builtins.elemAt fg 0); # Color of focused breadcrumb items.
        "breadcrumb.activeSelectionForeground" =
          hex (builtins.elemAt fg 0); # Color of selected breadcrumb items.
        "breadcrumbPicker.background" = hex
          (builtins.elemAt bg 0); # Background color of breadcrumb item picker
        ...
        "charts.foreground" =
          hex (builtins.elemAt fg 0); # Contrast color for text in charts.
        "charts.lines" =
          hex (builtins.elemAt fg 0); # Color for lines in charts.
        ...
        "charts.yellow" =
          hex yellow.default; # Color for yellow elements in charts.
        "charts.orange" =
          hex orange.default; # Color for orange elements in charts.
        "charts.green" =
          hex green.default; # Color for green elements in charts.
        "charts.purple" =
          hex purple.default; # Color for purple elements in charts
      };
    };
  };
}
