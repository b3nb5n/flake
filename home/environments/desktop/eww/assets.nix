{ const, usrLib, ... }: {
  xdg.configFile = with const.theme.color // usrLib.color; {
    "eww/assets/nix-logo.svg".text = ''
    ...
    "eww/assets/disk.svg".text = ''
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="${hex (builtins.elemAt fg 2)}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-hard-drive">
